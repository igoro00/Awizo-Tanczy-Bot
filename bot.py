...
#Create key.py file and type 'key = "{YOUR KEY}"' and replace {YOUR KEY} with your actual key
...
def start(update, context):
    update.message.reply_text("Wyślij plik dźwiękowy a odeślę ci film jak awizo tańczy do tej piosenki.\n\nJeśli audio jest dluższe od filmu(ok. 8s) to wykorzystane będzie tylko początek.\nBTW póki mam miejsce na dysku to sobie zachowuje te przeróbki.")
